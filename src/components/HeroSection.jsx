...
export function HeroSection() {
  ...
  return (
    <section id="learn" className="bg-gradient-to-br from-blue-600 via-blue-700 to-slate-900 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <a href="#calculators">{t('viewCalculators')}</a>
              </Button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-blue-500">
              <div className="text-center">
                ...
                <div className="text-blue-200 text-sm">{t('components')}</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">3</div>
                <div className="text-blue-200 text-sm">{t('calculators')}</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">2</div>
                <div className="text-blue-200 text-sm">{t('languages')}</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-4 bg-white text-gray-800 rounded-lg p-3 shadow-lg">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium">{t('didactic')}</span>
              </div>
            </div>
            ...
            <div className="absolute -bottom-4 -left-4 bg-white text-gray-800 rounded-lg p-3 shadow-lg">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium">{t('interactive')}</span>
              </div>
            </div>
          </div>
        </div>
